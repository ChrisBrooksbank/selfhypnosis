...
- [ ] Replace `public/manifest.json` with `app/manifest.ts` — Next.js `MetadataRoute.Manifest` returning name, short_name, icons (192, 384, 512), theme_color `#6366f1`, background_color, display `standalone`. See specs/pwa-shell.md.
